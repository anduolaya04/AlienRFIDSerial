...
public class MessageListenerEngine extends Thread implements MessageListener {
    ...
    public void run() {
        ...
        try {
            ...
            errorMessage.setReason(var6.getMessage());
        ...
        try {
            ...
            errorMessage = new ErrorMessage();
            errorMessage.setReason("Message Listener " + this.engineID + ": Error - stopped service: " + var7.getMessage());
            this.deliverMessageToListener(errorMessage);
        }
